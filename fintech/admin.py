    ...
    fieldsets = (
        ...
        ('ETF-Holdings-Referenz', {
            ...
            'description': (
                ...
                'asset_class=ETF erlaubt) — ergänzt zusätzlich die von JustETF noch nicht erfassten '
                'Positionen von Wikipedia (DAX) bzw. companiesmarketcap.com (MSCI World), aber nur '
                'für bereits bekannte Aktien (Namensabgleich). ark_ticker (z.B. "ARKK"): ersetzt die JustETF-Top-10 '
